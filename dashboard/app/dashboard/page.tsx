...
type PaletteKey = "forest" | "arctic" | "midnight" | "noir" | "lavender";
...
function getColors(settings: Settings): Colors {
  const p = PALETTES[settings.palette] ?? PALETTES.forest;
...
export default function DashboardPage() {
  ...
  const [C, setC] = useState<Colors>(PALETTES.forest.light);
