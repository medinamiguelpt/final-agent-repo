...
export const CURRENCIES: Record<CurrencyCode, Currency> = {
  EUR: {
    ...
    flag: "🇪🇺",
    decimals: 2,
    tierMonthly: { light: 99, standard: 149, heavy: 499 },
    roundStep: 1,
  ...
  USD: {
    ...
    flag: "🇺🇸",
    decimals: 2,
    tierMonthly: { light: 109, standard: 159, heavy: 549 },
    roundStep: 1,
  ...
  GBP: {
    ...
    flag: "🇬🇧",
    decimals: 2,
    tierMonthly: { light: 89, standard: 129, heavy: 429 },
    roundStep: 1,
  ...
  CHF: {
    ...
    flag: "🇨🇭",
    decimals: 2,
    tierMonthly: { light: 99, standard: 149, heavy: 489 },
    roundStep: 1,
    overageByTier: { light: 0.6, standard: 0.5, heavy: 0.4 },
  },
  CAD: {
    ...
    flag: "🇨🇦",
    decimals: 2,
    tierMonthly: { light: 149, standard: 219, heavy: 739 },
    roundStep: 1,
  ...
  AUD: {
    ...
    flag: "🇦🇺",
    decimals: 2,
    tierMonthly: { light: 159, standard: 239, heavy: 799 },
    roundStep: 1,
  ...
  SEK: {
    ...
    flag: "🇸🇪",
    decimals: 2,
    tierMonthly: { light: 1099, standard: 1699, heavy: 5699 },
    roundStep: 10,
  ...
  NOK: {
    ...
    flag: "🇳🇴",
    decimals: 2,
    tierMonthly: { light: 1099, standard: 1699, heavy: 5799 },
    roundStep: 10,
    overageByTier: { light: 6.9, standard: 5.7, heavy: 4.5 },
  },
  DKK: {
    ...
    flag: "🇩🇰",
    decimals: 2,
    tierMonthly: { light: 749, standard: 1099, heavy: 3699 },
    roundStep: 10,
  ...
  PLN: {
    ...
    flag: "🇵🇱",
    decimals: 2,
    tierMonthly: { light: 429, standard: 649, heavy: 2149 },
    roundStep: 1,
  ...
  AED: {
    ...
    flag: "🇦🇪",
    decimals: 2,
    tierMonthly: { light: 399, standard: 599, heavy: 1999 },
    roundStep: 1,
  ...
  JPY: {
    ...
    flag: "🇯🇵",
    decimals: 0,
    tierMonthly: { light: 16000, standard: 24000, heavy: 81000 },
    roundStep: 100,
