...
export const CURRENCIES: Record<CurrencyCode, Currency> = {
  EUR: {
    ...
    flag: "🇪🇺",
    decimals: 2,
    tierMonthly: { light: 99, standard: 329, heavy: 799 },
    roundStep: 1,
    overageByTier: { light: 0.6, standard: 0.5, heavy: 0.4 },
  },
  USD: {
    code: "USD",
    locale: "en-US",
    ...
    flag: "🇺🇸",
    decimals: 2,
    tierMonthly: { light: 109, standard: 349, heavy: 849 },
    roundStep: 1,
    overageByTier: { light: 0.65, standard: 0.55, heavy: 0.45 },
  },
  GBP: {
    code: "GBP",
    locale: "en-GB",
    ...
    flag: "🇬🇧",
    decimals: 2,
    tierMonthly: { light: 89, standard: 279, heavy: 679 },
    roundStep: 1,
    overageByTier: { light: 0.55, standard: 0.45, heavy: 0.35 },
  },
  CHF: {
    code: "CHF",
    locale: "de-CH",
    ...
    flag: "🇨🇭",
    decimals: 2,
    tierMonthly: { light: 99, standard: 319, heavy: 779 },
    roundStep: 1,
    overageByTier: { light: 0.6, standard: 0.5, heavy: 0.4 },
  },
  CAD: {
    ...
    flag: "🇨🇦",
    decimals: 2,
    tierMonthly: { light: 149, standard: 479, heavy: 1199 },
    roundStep: 1,
    overageByTier: { light: 0.9, standard: 0.75, heavy: 0.6 },
  },
  AUD: {
    code: "AUD",
    locale: "en-AU",
    ...
    flag: "🇦🇺",
    decimals: 2,
    tierMonthly: { light: 159, standard: 539, heavy: 1299 },
    roundStep: 1,
    overageByTier: { light: 0.99, standard: 0.79, heavy: 0.65 },
  },
  SEK: {
    code: "SEK",
    locale: "sv-SE",
    ...
    flag: "🇸🇪",
    decimals: 2,
    tierMonthly: { light: 1099, standard: 3799, heavy: 9199 },
    roundStep: 10,
    overageByTier: { light: 6.9, standard: 5.7, heavy: 4.5 },
  },
  NOK: {
    code: "NOK",
    locale: "nb-NO",
    ...
    flag: "🇳🇴",
    decimals: 2,
    tierMonthly: { light: 1099, standard: 3899, heavy: 9299 },
    roundStep: 10,
    overageByTier: { light: 6.9, standard: 5.7, heavy: 4.5 },
  },
  DKK: {
    ...
    flag: "🇩🇰",
    decimals: 2,
    tierMonthly: { light: 749, standard: 2449, heavy: 5999 },
    roundStep: 10,
    overageByTier: { light: 4.5, standard: 3.7, heavy: 3.0 },
  },
  PLN: {
    code: "PLN",
    locale: "pl-PL",
    ...
    flag: "🇵🇱",
    decimals: 2,
    tierMonthly: { light: 429, standard: 1429, heavy: 3449 },
    roundStep: 1,
    overageByTier: { light: 2.6, standard: 2.2, heavy: 1.7 },
  },
  AED: {
    code: "AED",
    locale: "en-AE",
    ...
    flag: "🇦🇪",
    decimals: 2,
    tierMonthly: { light: 399, standard: 1299, heavy: 3199 },
    roundStep: 1,
    overageByTier: { light: 2.4, standard: 2.0, heavy: 1.6 },
  },
  JPY: {
    code: "JPY",
    locale: "ja-JP",
    ...
    flag: "🇯🇵",
    decimals: 0,
    tierMonthly: { light: 16000, standard: 54000, heavy: 129000 },
    roundStep: 100,
    overageByTier: { light: 100, standard: 85, heavy: 70 },
  },
};
